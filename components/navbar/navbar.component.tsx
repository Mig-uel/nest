...
import UnreadMessageCount from '../message/unread-message-count.component'
          ...
          {!session && (
            <div className='hidden md:block md:ml-6'>
              <div className='flex items-center'>
                {authProviders &&
                  Object.values(authProviders).map((provider, index) => (
                    <button
                      key={index}
                      // @ts-ignore
          ...
          >
            <Link
              ...
              className={`text-white block rounded-md px-3 py-2 text-base font-medium ${
                pathname === '/' ? 'bg-black' : 'first-letter:'
              }`}
            >
              Home
            </Link>
            <Link
              href='/properties'
              className={`text-white block rounded-md px-3 py-2 text-base font-medium ${
                pathname === '/properties' ? 'bg-black' : 'first-letter:'
              }`}
            >
              Properties
            </Link>
            ...
            {session && (
              <Link
                href='/properties/add'
                className={`text-white block rounded-md px-3 py-2 text-base font-medium ${
                  pathname === '/properties/add' ? 'bg-black' : 'first-letter:'
                }`}
              >
                Add Property
              </Link>
